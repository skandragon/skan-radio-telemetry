...
{
    {
        ...
        icon = "__skan_wireless-signals__/resources/icons/radio-transmitter-1.png",
        ...
        fast_replaceable_group = "skan-radio-equipment",
        energy_source =
        {
            type = "electric",
        ...
        picture_off =
        {
            filename = "__skan_wireless-signals__/resources/entity/radio-transmitter-1.png",
            priority = "high",
            width = 235,
            height = 207,
            frame_count = 1,
        ...
        picture_on =
        {
            filename = "__skan_wireless-signals__/resources/blank.png",
            priority = "high",
            width = 1,
            height = 1,
            frame_count = 1,
  ...
  },
  {
        ...
        icon = "__skan_wireless-signals__/resources/icons/radio-transmitter-2.png",
        flags = {"placeable-neutral", "player-creation"},
        ...
        picture_off =
        {
            filename = "__skan_wireless-signals__/resources/entity/radio-transmitter-2.png",
            priority = "high",
            width = 262,
            height = 228,
            frame_count = 1,
  ...
  },
    {
        ...
        sprites =
        {
            north =
            {
                filename = "__skan_wireless-signals__/resources/entity/radio-receiver.png",
                width = 203,
                height = 179,
                frame_count = 1,
                shift = {2.25, -1.91},
